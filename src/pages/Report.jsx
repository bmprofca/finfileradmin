...
import {
  ...
  FaUndo, FaFilter, FaUserTie, FaBoxOpen,
} from "react-icons/fa";
...
// Turns "pending_from_client" -> "Pending from client", "created_orders" -> "Created"
...
export default function Report() {
  ...
  // Guards against the mount → fetch → refetch double-call some dev setups
  // (e.g. React StrictMode double-invoking effects) trigger.
  ...
  // order_status_summary is an OBJECT keyed by status name, not an array
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="flex flex-col gap-1">
        <h1 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Reports</h1>
        <p className="text-sm text-gray-400 dark:text-gray-500">
          Overview of orders, payments, and client activity
        </p>
      </div>
      ...
      >
        <div className="flex flex-wrap items-end gap-3">
          ...
          <div className="min-w-[180px] flex-1">
            <label className="mb-1 block text-xs font-medium text-gray-500 dark:text-gray-400">Staff username</label>
            <input
              type="text"
              value={filters.staff_username}
              onChange={(e) => setFilters((prev) => ({ ...prev, staff_username: e.target.value }))}
              placeholder="Search staff"
              className="w-full rounded-md border border-slate-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200"
            />
          </div>

          <div className="min-w-[180px] flex-1">
            <label className="mb-1 block text-xs font-medium text-gray-500 dark:text-gray-400">Client username</label>
            <input
              type="text"
              value={filters.client_username}
              onChange={(e) => setFilters((prev) => ({ ...prev, client_username: e.target.value }))}
